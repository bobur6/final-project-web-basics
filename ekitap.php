...
<div class="bar1">
	<div class="site_info">
		<div class="site_info_cont">
			<div>
				<h1>E-KITAP</h1>
				<p>"Чтение книг — не способ бегства от жизни, книги дают ключ к ее пониманию!"</p>
				<p><b>Ключ к реальности!</b></p>
				<span>Себастьян Фолкс</span>
				<p>"Книга – это ключ открывающий мир истинного знания!"</p>
				<span>Карл Джейкобсон</span>
			</div>
		</div>
		<div class="site_info_list">
			<ul>
				<?php
					include 'data.php';
					foreach ($site_info_list as $text) {
				        echo "<li>" . $text . "</li>";
				    }
				?>
			</ul>
		...
		<div class="book_list">
			...
			?>
							<div class="book">
								...
								<a href="oneBook.php?id=<?= $book[$i]['id'];?>"><?=$book[$i]['name'];?></a>
								<p><?=$book[$i]['author'];?></p>
...
<div class="cats">
	<?php
		...
		for ($i=0; $i<count($cat); $i++) {
			echo "<a href='ekitap.php" . $cat[$i]['link'] . "#books'>" . $cat[$i]['text'] . "</a>";
		}	
	?>
</div>
...
<div id="books">
	<div class="container">
		...
		<div class="book_list">
			...
			<?php				
					for($i=0; $i<count($book); $i++){ 
						if($_GET['category'] == $book[$i]['category']){
			?>
...
<div id="loc">
	<div class="container">
		...
		<div class="loc_list">
			<div class="loc">
				<img src="images/loc1.jpg" alt="locations in map"><br>
				<a href="https://go.2gis.com/c9s24s" target="_blank">E-KITAP ТРЦ «АДК»</a>
				<p>ул. Сатпаева, 90, 2 этаж возле кинотеатра Chaplin Cinema</p>
				<p>-</p>
				<span>Режим работы 10:00-22:00 без выходных.</span><br>
				<span>Телефон: +7 727 338 36 96 вн. 1250</span>
			</div>
			<div class="loc">
				<img src="images/loc2.jpg" alt="locations in map"><br>
				<a href="https://go.2gis.com/ve3uv" target="_blank">E-KITAP на Гоголя (Grand)</a>
				<p>ул. Гоголя, 58 (уг. ул. Панфилова)</p>
				<p>-</p>
				<span>Режим работы Круглосут., без выходных</span><br>
				<span>Телефон: +7 727 338 36 96 вн. 1503</span>
			</div>
			<div class="loc">
				<img src="images/loc3.jpg" alt="locations in map"><br>
				<a href="https://go.2gis.com/p36hr" target="_blank">E-KITAP ТРЦ «MEGA Park»</a>
				<p>ул. Сейфулина 483, уг. ул. Макатаева, 2 этаж</p>
				<p>-</p>
				<span>Режим работы 10:00-22:00 без выходных.</span><br>
				<span>Телефон: +7 727 338-36-96 вн. 1236</span>
			</div>
			<div class="loc">
				<img src="images/loc4.jpg" alt="locations in map"><br>
				<a href="https://go.2gis.com/tucjoh" target="_blank">E-KITAP ТРЦ «MEGA Alma-Ata»</a>
				<p>ул. Розыбакиева 247, 2 этаж возле кинотеатра в старом крыле</p>
				<p>-</p>
				<span>Режим работы 10:00-22:00 без выходных.</span><br>
				<span>Телефон: 8 (727) 33 83 696 вн 1526,1527</span>
			</div>
		</div>
	</div>	
</div>
